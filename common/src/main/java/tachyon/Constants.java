...
public class Constants {
  ...
  public static final String WORKER_ASYNC_CHECKPOINT = "tachyon.worker.checkpoint.always";
  ...
  public static final String USER_DEFAULT_READ_TYPE = "tachyon.user.file.readtype.default";
