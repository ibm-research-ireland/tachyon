...
public class WorkerService {
  ...
  public interface Iface {
    ...
    public boolean asyncCheckpoint(long userId, int fileId) throws TachyonException, org.apache.thrift.TException;
     ...
     * @param dirty
     */
    public void cacheBlock(long userId, long blockId, boolean dirty) throws FileDoesNotExistException, BlockInfoException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void asyncCheckpoint(long userId, int fileId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void cacheBlock(long userId, long blockId, boolean dirty, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean asyncCheckpoint(long userId, int fileId) throws TachyonException, org.apache.thrift.TException
    {
      send_asyncCheckpoint(userId, fileId);
      return recv_asyncCheckpoint();
    }

    public void send_asyncCheckpoint(long userId, int fileId) throws org.apache.thrift.TException
    {
    ...
    public void cacheBlock(long userId, long blockId, boolean dirty) throws FileDoesNotExistException, BlockInfoException, org.apache.thrift.TException
    {
      send_cacheBlock(userId, blockId, dirty);
      recv_cacheBlock();
    }

    public void send_cacheBlock(long userId, long blockId, boolean dirty) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void asyncCheckpoint(long userId, int fileId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      asyncCheckpoint_call method_call = new asyncCheckpoint_call(userId, fileId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class asyncCheckpoint_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long userId;
      private int fileId;
      public asyncCheckpoint_call(long userId, int fileId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
        this.fileId = fileId;
      }
    ...
    public void cacheBlock(long userId, long blockId, boolean dirty, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      cacheBlock_call method_call = new cacheBlock_call(userId, blockId, dirty, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class cacheBlock_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public cacheBlock_call(long userId, long blockId, boolean dirty, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
        this.blockId = blockId;
        this.dirty = dirty;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class asyncCheckpoint<I extends Iface> extends org.apache.thrift.ProcessFunction<I, asyncCheckpoint_args> {
      ...
      public asyncCheckpoint_result getResult(I iface, asyncCheckpoint_args args) throws org.apache.thrift.TException {
        asyncCheckpoint_result result = new asyncCheckpoint_result();
        try {
          result.success = iface.asyncCheckpoint(args.userId, args.fileId);
    ...
    public static class cacheBlock<I extends Iface> extends org.apache.thrift.ProcessFunction<I, cacheBlock_args> {
      ...
      public cacheBlock_result getResult(I iface, cacheBlock_args args) throws org.apache.thrift.TException {
        cacheBlock_result result = new cacheBlock_result();
        try {
          iface.cacheBlock(args.userId, args.blockId, args.dirty);
        } catch (FileDoesNotExistException eP) {
          result.eP = eP;
        } catch (BlockInfoException eB) {
          result.eB = eB;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class asyncCheckpoint<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, asyncCheckpoint_args, Boolean> {
      ...
      public void start(I iface, asyncCheckpoint_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws TException {
        iface.asyncCheckpoint(args.userId, args.fileId,resultHandler);
      }
    }
    ...
    public static class cacheBlock<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, cacheBlock_args, Void> {
      ...
      public void start(I iface, cacheBlock_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.cacheBlock(args.userId, args.blockId, args.dirty,resultHandler);
      }
    }
...
;
  ...
  public static class asyncCheckpoint_args implements org.apache.thrift.TBase<asyncCheckpoint_args, asyncCheckpoint_args._Fields>, java.io.Serializable, Cloneable, Comparable<asyncCheckpoint_args>   {
    ...
    public asyncCheckpoint_args setUserId(long userId) {
      this.userId = userId;
      setUserIdIsSet(true);
      return this;
    }
  ...
  public static class cacheBlock_args implements org.apache.thrift.TBase<cacheBlock_args, cacheBlock_args._Fields>, java.io.Serializable, Cloneable, Comparable<cacheBlock_args>   {
    ...
    private static final org.apache.thrift.protocol.TField DIRTY_FIELD_DESC = new org.apache.thrift.protocol.TField("dirty", org.apache.thrift.protocol.TType.BOOL, (short)3);
    ...
    private static final int __DIRTY_ISSET_ID = 2;
    private byte __isset_bitfield = 0;
    public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      ...
      tmpMap.put(_Fields.BLOCK_ID, new org.apache.thrift.meta_data.FieldMetaData("blockId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
      tmpMap.put(_Fields.DIRTY, new org.apache.thrift.meta_data.FieldMetaData("dirty", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public cacheBlock_args setDirty(boolean dirty) {
      this.dirty = dirty;
      setDirtyIsSet(true);
      return this;
    }
    ...
    public void unsetDirty() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __DIRTY_ISSET_ID);
    }

    /** Returns true if field dirty is set (has been assigned a value) and false otherwise */
    public boolean isSetDirty() {
      return EncodingUtils.testBit(__isset_bitfield, __DIRTY_ISSET_ID);
    }

    public void setDirtyIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __DIRTY_ISSET_ID, value);
    }
    ...
    public boolean equals(cacheBlock_args that) {
      ...
      boolean this_present_dirty = true;
      boolean that_present_dirty = true;
    ...
    public int hashCode() {
      ...
      boolean present_dirty = true;
      list.add(present_dirty);
      if (present_dirty)
        list.add(dirty);
    ...
    public int compareTo(cacheBlock_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetDirty()).compareTo(other.isSetDirty());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDirty()) {
